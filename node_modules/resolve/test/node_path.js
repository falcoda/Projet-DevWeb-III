...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/index.cjs'), 'aaa resolves');
    });
    ...
    resolve('bbb', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/index.cjs'), 'bbb resolves');
    });
    ...
    resolve('ccc', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/index.cjs'), 'ccc resolves');
    });
